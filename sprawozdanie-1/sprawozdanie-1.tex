...
W~algorytmie zamierzamy wykorzystać algorytm przeglądanie grafu w~głąb lub
...
zaczynając z~pierwszego wierzchołka z~$V2$. Dla wykonanego przejścia należy
sprawdzić, czy wszystkie odwiedzone wierzchołki zawierają się w~zbiorze $V1$.
Jeśli nie, oznacza to, że~graf nie jest częściowo spójny. Jeśli tak, to~należy
powtórzyć krok, do~momentu, gdy zbiór $V1$, będzie stanowił wszystkie
wierzchołki wejściowego grafu, lub nie osiągniemy odwiedzonych do~tej pory
wierzchołków z~$V1$.
