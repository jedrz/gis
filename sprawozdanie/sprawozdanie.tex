...
\subsection{Wielokrotne przeglądanie grafu}

\subsection{Bazujący na~wyszukiwaniu silnie spójnych składowych}
...
na~grafach o~większym rozmiarze. Wytworzony generator posłuży nam także
do~generacji większych grafów oraz weryfikacji złożoności czasowych algorytmów.
